    ...
    <div>
      ...
      <section className='blogs'>
        <article className='blog'>
          <figure>
            <Image src={semanaTecnica} alt="Image prueba" width="100%"/>
          </figure>
          <div>
        ...
        <article className='blog'>
          <figure>
            <Image src={paraulataDorada} alt="Image prueba" width="100%"/>
          </figure>
          <div>
        ...
        <article className='blog'>
          <figure>
            <Image src={adoracionLLanera} alt="Image prueba" width="100%"/>
        ...
        <article className='blog'>
          <figure>
            <Image src={cabalgata} alt="Image prueba" width="100%"/>
          </figure>
          <div>
        ...
        <article className='blog'>
          <figure>
            <Image src={cachodeoro} alt="Image prueba" width="100%"/>
          </figure>
          <div>
        ...
        <article className='blog'>
          <figure>
            <Image src={festival} alt="Image prueba" width="100%"/>
          </figure>
          <div>
